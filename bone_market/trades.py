...
def add_trades(config: Config):
    ...
    entrepreneur_buyers.add_trade(config, Flux.Amalgamy, ZooType.Bird, coral_bird_seven_recipe)
    entrepreneur_buyers.add_trade(config, Flux.Amalgamy, ZooType.NoType, coral_bird_seven_recipe)
    ...
    entrepreneur_buyers.add_trade(config, Flux.Amalgamy, ZooType.Bird, coral_bird_eight_recipe)
    entrepreneur_buyers.add_trade(config, Flux.Amalgamy, ZooType.NoType, coral_bird_eight_recipe)
